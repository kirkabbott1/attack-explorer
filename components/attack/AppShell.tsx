...
export default function AppShell({ sidebar, canvas, detailPanel, detailPanelOpen }: AppShellProps) {
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-darkblue text-lightteal">
      <aside
        className="w-[320px] flex-shrink-0 border-r border-darkteal/30 bg-darkblue/95 overflow-y-auto"
      ...
      <aside
        className={`flex-shrink-0 border-l border-darkteal/30 bg-darkblue/95 overflow-y-auto transition-all duration-200 ${
